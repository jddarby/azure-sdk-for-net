...
{
    /// <summary>
    /// A class representing the ContainerizedNetworkFunctionDefinitionVersionData data model.
    /// Containerized network function definition version.
    /// </summary>
    public partial class ContainerizedNetworkFunctionDefinitionVersionData : NetworkFunctionDefinitionVersionData
    {
        /// <summary> Initializes a new instance of ContainerizedNetworkFunctionDefinitionVersionData. </summary>
        ...
        internal ContainerizedNetworkFunctionDefinitionVersionData(ResourceIdentifier id, string name, ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ProvisioningState? provisioningState, VersionState? versionState, string description, string deployParameters, NetworkFunctionType? networkFunctionType, ContainerizedNetworkFunctionTemplate networkFunctionTemplate) : base(id, name, resourceType, systemData, tags, location, provisioningState, versionState, description, deployParameters, networkFunctionType)
        {
