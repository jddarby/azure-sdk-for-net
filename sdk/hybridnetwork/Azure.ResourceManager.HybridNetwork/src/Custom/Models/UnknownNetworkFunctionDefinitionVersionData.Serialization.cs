...
{
    public partial class UnknownNetworkFunctionDefinitionVersionData : IUtf8JsonSerializable
    {
        ...
        internal static UnknownNetworkFunctionDefinitionVersionData DeserializeUnknownNetworkFunctionDefinitionVersionData(JsonElement element)
        {
            ...
            return new UnknownNetworkFunctionDefinitionVersionData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(provisioningState), Optional.ToNullable(versionState), description.Value, deployParameters.Value, Optional.ToNullable(networkFunctionType));
        }
    }
}
