...
{
    public partial class ContainerizedNetworkFunctionDefinitionVersionData : IUtf8JsonSerializable
    {
        ...
        internal static ContainerizedNetworkFunctionDefinitionVersionData DeserializeContainerizedNetworkFunctionDefinitionVersionData(JsonElement element)
        {
            ...
            return new ContainerizedNetworkFunctionDefinitionVersionData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(provisioningState), Optional.ToNullable(versionState), description.Value, deployParameters.Value, Optional.ToNullable(networkFunctionType), networkFunctionTemplate);
        }
    }
}
