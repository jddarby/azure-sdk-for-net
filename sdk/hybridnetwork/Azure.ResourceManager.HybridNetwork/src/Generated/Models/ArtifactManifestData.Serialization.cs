...
{
    public partial class ArtifactManifestData : IUtf8JsonSerializable
    {
        ...
        internal static ArtifactManifestData DeserializeArtifactManifestData(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("artifactManifestState"u8))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                continue;
                            }
                            artifactManifestState = new ArtifactManifestState(property0.Value.GetString());
                            continue;
                        }
            ...
            return new ArtifactManifestData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(provisioningState), Optional.ToNullable(artifactManifestState), Optional.ToList(artifacts));
        }
    }
}
