...
{
    public partial class ArmTemplateApplicationOverview : IUtf8JsonSerializable
    {
        ...
        internal static ArmTemplateApplicationOverview DeserializeArmTemplateApplicationOverview(JsonElement element)
        {
            ...
            return new ArmTemplateApplicationOverview(name.Value, artifactType, deployParametersMappingRuleProfile.Value);
        }
    }
}
