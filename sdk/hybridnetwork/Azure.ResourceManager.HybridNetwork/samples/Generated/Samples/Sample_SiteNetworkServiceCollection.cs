...
{
    public partial class Sample_SiteNetworkServiceCollection
    {
        // Get network site
        ...
        public async Task Get_GetNetworkSite()
        {
            ...
            SiteNetworkServiceResource result = await collection.GetAsync(siteNetworkServiceName);
        ...
        public async Task Exists_GetNetworkSite()
        {
            ...
            // invoke the operation
            string siteNetworkServiceName = "testSiteNetworkServiceName";
            bool result = await collection.ExistsAsync(siteNetworkServiceName);
...
Id = new ResourceIdentifier("/subscriptions/subid/resourcegroups/contosorg1/providers/microsoft.hybridnetwork/configurationgroupvalues/MyVM_Configuration1"),
        ...
        {
            // Generated from example definition: specification/hybridnetwork/resource-manager/Microsoft.HybridNetwork/stable/2023-09-01/examples/SiteNetworkServiceListByResourceGroup.json
            // this example is just showing the usage of "SiteNetworkServices_ListByResourceGroup" operation, for the dependent resources, they will have to be created separately.
            ...
            await foreach (SiteNetworkServiceResource item in collection.GetAllAsync())
            {
